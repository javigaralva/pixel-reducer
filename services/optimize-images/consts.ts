...
export const CLOUDINARY_OPTIMIZED_URL = 'https://res.cloudinary.com/demo/image/fetch/q_auto:low'
export const CLOUDINARY_THUMBNAIL_URL = 'https://res.cloudinary.com/demo/image/fetch/c_scale,c_lfill,w_200,q_auto:low'
